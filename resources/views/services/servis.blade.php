...
<script>
                ...
                <div class="bg-white rounded-lg shadow-lg p-8">
                    ...
                    <form id="reservation-form" action="{{ route('services.submit') }}" method="POST" enctype="multipart/form-data" class="mx-auto mt-10 sm:mt-16 max-w-md sm:max-w-xl">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            ...
                            <div class="sm:col-span-2">
                                <label class="block text-sm font-semibold leading-6 text-black">Tentukan Lokasi Anda di Peta</label>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        // Tambahkan penanda awal yang bisa digeser
        ...
        // Event saat penanda selesai digeser
